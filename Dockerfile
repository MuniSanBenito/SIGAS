...
# Placeholders so `next build` can load the Payload config. They exist only for this command.
RUN PAYLOAD_SECRET=build-only DATABASE_URL=mongodb://127.0.0.1:27017/sigas pnpm run build
