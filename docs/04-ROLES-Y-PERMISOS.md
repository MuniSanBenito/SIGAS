...
| **Administración** | Consulta y actualiza contribuyentes. Crea y mantiene grupos, referentes, integrantes y parentescos. Confirma entregas de bolsones. No modifica stock. |
...
| Confirmar entregas | V/C/E/B | – | V/C/E/B |
| Anular entregas confirmadas | V/C | – | – |
| Reportes de stock | V | V | – |
| Reportes de entregas | V | – | – |
| Auditoría | V | – | – |

En esta primera implementación se habilitan rutas y navegación para grupos familiares, inventario y entregas. Las tarjetas informativas de Reportes quedan visibles únicamente para el Administrador hasta construir sus pantallas y rutas.
...
- El Administrador y Administración pueden confirmar entregas en esta primera matriz de roles.
- Solo el Administrador puede anular una entrega confirmada.
- Control de stock no accede al historial de entregas desde sus módulos.
